...
export function entityMutationFields() {
	return {
		createdBy: reference("CreatedBy", "SystemUser", { readOnly: true }),
		createdOn: dateTime("CreatedOn", { readOnly: true }),
		modifiedBy: reference("ModifiedBy", "SystemUser", { readOnly: true }),
		modifiedOn: dateTime("ModifiedOn", { readOnly: true }),
	} as const;
}
